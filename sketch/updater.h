const char* firmwareVer = "0.2.1";  // Version number
...
void firmwareUpdate() {  // Updater
  ...
  if ((!strcmp(new_version.c_str(), firmwareVer)) || (!new_version.c_str() || new_version.c_str() == "")) return;  // Check if version is the same
