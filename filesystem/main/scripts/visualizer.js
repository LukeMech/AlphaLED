...
async function sendPixelDataToArduino() {
    ...
    for (let y = 0; y < 8; y++) {
        ...
        const barHeight = (((frequencyData[j] + frequencyData[j*2] + frequencyData[j*3] + frequencyData[j*4] + frequencyData[j*5] + frequencyData[j*6] + frequencyData[j*7] + frequencyData[j*8]) / 8) / 255)
